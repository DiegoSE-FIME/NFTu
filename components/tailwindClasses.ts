...
export const theme: ITheme = {
	...
	navbarLoginButton:
		'inline-flex items-center h-10 px-5 mt-2.5 text-white transition-colors border border-teal-200 duration-150 rounded-full focus:shadow-outline hover:bg-teal-800 hidden xl:inline-flex',
	signInButton:
