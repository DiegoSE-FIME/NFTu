...
export const theme: ITheme = {
	...
	button:
		'inline-flex items-center bg-gradient-to-r from-[#f0f4fd] to-indigo-500 h-10 px-5 mt-2.5 text-black font-bold transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-teal-200 hidden xl:inline-flex',
	signOutButton:
		'inline-flex items-center h-10 xl:mb-0 mb-5 px-5 xl:m-2 m-5 text-black bg-white font-bold mt-2.5 transition-colors duration-150  rounded-full focus:shadow-outline hover:bg-slate-200',
	bodyTitle:
