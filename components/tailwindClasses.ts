...
export const theme: ITheme = {
	...
	bodyDiv:
		'lg:flex lg:flex-row lg:justify-center items-center lg:py-24 lg:flex lg:flex-row lg:justify-center items-center lg:py-24 p-5',
	description: 'leadign-[1.15] text-base text-gray-400 mt-5 lg:w-3/4 mb-5',
	getStartedButton:
	...
	connectWalletButton:
		'inline-flex items-center bg-violet-700 h-10 px-5 mt-2.5 text-white transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-violet-800 hidden xl:inline-flex',
	signInButton:
		'inline-flex items-center bg-violet-700 h-10 px-5 mt-2.5 xl:mb-0 mb-5 text-white transition-colors duration-150  rounded-full focus:shadow-outline hover:bg-violet-800',
	signOutButton:
		'inline-flex items-center h-10 xl:mb-0 mb-5 px-5 xl:m-2 m-5 border border-violet-500 mt-2.5 transition-colors duration-150  rounded-full focus:shadow-outline hover:bg-violet-700',
	bodyTitle:
		'text-2xl px-5 text-bold xl:text-bold w-64 xl:px-0 xl:w-screen 2-xl:mx-auto xl:text-4xl xl:pt-32',
	gradientAqua:
		'absolute top-[150px] right-0 xl:absolute xl:right-9 xl:top-[15%] rounded-full opacity-100  blur-2xl',
