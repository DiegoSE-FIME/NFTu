...
export const theme: ITheme = {
	...
	button:
		'inline-flex items-center bg-[#BBFFFF] h-10 px-5 mt-2.5 text-black font-bold transition-colors duration-150 rounded-full focus:shadow-outline hover:bg-teal-200 hidden xl:inline-flex',
	signOutButton:
