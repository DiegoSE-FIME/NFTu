			...
			<div>
				...
				<div className="xl:mt-5 xl:w-[500px] w-96 px-5 xl:px-0">
					<p className={theme.headerDescription}>
						...
						cum ullam obcaecati non possimus! Nihil inventore aspernatur
						corporis quia architecto et voluptate molestias officia, illo
						doloribus. Nemo ex quaerat nihil.
					</p>
				</div>
			</div>
		</div>
